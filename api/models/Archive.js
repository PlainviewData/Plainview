...
archiveSchema.statics.createNew = function createNew(url, quote, options){
	return new Promise(function(resolve, reject){
		if (typeof url !== 'string' && (url instanceof String) === false || validator.isURL(url) === false) reject(MESSAGES.INVALID_URL); //TODO: Create validator object
		...
		.then(function(foundArticle){
			...
			if (article.original_headline.indexOf(quote) === -1 && article.original_story_content.indexOf(quote) === -1){ //TODO: Create checker object
